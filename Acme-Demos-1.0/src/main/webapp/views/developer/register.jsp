...
<form:form requestURI="${requestUri}" modelAttribute="developerForm">
	<fieldset>
		...
		<acme:password code="developer.userAccount.repeatPassword" path="confirmPassword"/>
	</fieldset>
	...
	<p><acme:checkbox code="developer.acceptConditions" path="accept"/>
	
	<a href="legalTerms/legalTerms.do">
		<spring:message code="developer.registration" />
	</a>
